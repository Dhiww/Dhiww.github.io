...
?>
	...
	<h2 align="center">LAPORAN HARIAN KASIR WAROENG BERSAMA</h2>
	<H2 align="center">LAPORAN PENJUALAN HARIAN</H2>
	<H2 align="center">PERIODE <?= $tanggal ?></H2>
	<hr>
<?php
include "config.php";
?>
...
$nama=$_GET['id'];
$sql="select * from penjualan where TanggalPenjualan='$tanggal' order by PenjualanID";
